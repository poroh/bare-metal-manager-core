...
use model::site_explorer::{
    EndpointExplorationReport, EndpointType, InternalLockdownStatus, Inventory, LockdownStatus,
    MachineSetupDiff, MachineSetupStatus, Service,
};
...
pub async fn nv_generate_exploration_report_from_root<B: Bmc>(
    ...
    let service = nv_fetch_service(&root, hw_type).await?;
